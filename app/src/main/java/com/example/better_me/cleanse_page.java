...
public class cleanse_page extends AppCompatActivity {
    private Button frontbtn, savebtn;
    private CheckBox day1, day2, day3, day4, day5, day6, day7, day8, day9, day10, day11;
    private SharedPreferences sharedPreferences;
    private SharedPreferences newSharedPreferences; // New shared preferences object
    int i = 0;

    @Override
    protected void onResume() {
        super.onResume();
        newSharedPreferences = getSharedPreferences("NewPrefs", MODE_PRIVATE); // Initialize the new shared preferences object
        boolean isChecked1 = newSharedPreferences.getBoolean("checkbox1", false);
        boolean isChecked2 = newSharedPreferences.getBoolean("checkbox2", false);
        boolean isChecked3 = newSharedPreferences.getBoolean("checkbox3", false);
        boolean isChecked4 = newSharedPreferences.getBoolean("checkbox4", false);
        boolean isChecked5 = newSharedPreferences.getBoolean("checkbox5", false);
        boolean isChecked6 = newSharedPreferences.getBoolean("checkbox6", false);
        boolean isChecked7 = newSharedPreferences.getBoolean("checkbox7", false);
        boolean isChecked8 = newSharedPreferences.getBoolean("checkbox8", false);
        boolean isChecked9 = newSharedPreferences.getBoolean("checkbox9", false);
        boolean isChecked10 = newSharedPreferences.getBoolean("checkbox10", false);
        boolean isChecked11 = newSharedPreferences.getBoolean("checkbox11", false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cleanse_page);
    ...
    public void onSaveButtonClicked(View view) {
        ...
        SharedPreferences.Editor editor = newSharedPreferences.edit(); // Use the new shared preferences object
    ...
    public void gonext() {
        Intent intent = new Intent(cleanse_page.this, cleanse_page2.class);
