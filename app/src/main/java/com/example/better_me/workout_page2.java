...
public class workout_page2 extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        sharedPreferences = getSharedPreferences("OtherPrefs", MODE_PRIVATE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_page2);
        getSupportActionBar().hide();
