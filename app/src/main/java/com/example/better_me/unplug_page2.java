...
public class unplug_page2 extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        sharedPreferences = getSharedPreferences("CustomPrefs", MODE_PRIVATE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unplug_page2);
        getSupportActionBar().hide();
