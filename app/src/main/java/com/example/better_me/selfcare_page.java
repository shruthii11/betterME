...
public class selfcare_page extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        boolean isChecked1 = sharedPreferences.getBoolean("checkbox1", false);
        boolean isChecked2 = sharedPreferences.getBoolean("checkbox2", false);
        boolean isChecked3 = sharedPreferences.getBoolean("checkbox3", false);
        boolean isChecked4 = sharedPreferences.getBoolean("checkbox4", false);
        boolean isChecked5 = sharedPreferences.getBoolean("checkbox5", false);
        boolean isChecked6 = sharedPreferences.getBoolean("checkbox6", false);
        boolean isChecked7 = sharedPreferences.getBoolean("checkbox7", false);
        boolean isChecked8 = sharedPreferences.getBoolean("checkbox8", false);
        boolean isChecked9 = sharedPreferences.getBoolean("checkbox9", false);
        boolean isChecked10 = sharedPreferences.getBoolean("checkbox10", false);
        boolean isChecked11 = sharedPreferences.getBoolean("checkbox11", false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selfcare_page);
    ...
    public void gonext() {
        Intent intent = new Intent (this,selfcare2_page.class);
